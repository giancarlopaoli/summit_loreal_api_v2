...
<body style="font-family: 'Poppins';">
  <table style="margin: 0; padding: 20px 40px; width: 650px; margin: 0 auto; background-color: #fff;" cellpadding="0" cellspacing="0">
    ...
    <tr style="width: 650px;">
      <td align="center" class="information">
        <h4 style="margin-bottom: 0px;">El cliente {{ $client }} ha creado una operación interbancaria con los siguientes datos:</h4>

        <p><li>Monto: {{$currency_sign}}{{ $amount }}</li></p>
        <p><li>TC Compra: {{ $tc_compra }}</li></p>
        <p><li>TC Venta: {{ $tc_venta }}</li></p>
        <p><li>Spread Caja: {{ $spread_caja }}</li></p>
        <p><li>Comisión Caja: {{ $comision_caja }}</li></p>
        <p><li>Banco Origen: {{ $banco_origen }}</li></p>
        <p><li>Banco Destino: {{ $banco_destino }}</li></p>
        <p><li>Monto Total a Depositar: {{ $total_amount }}</li></p>
        <p><li>Comisión Billex: {{ $comision }}</li></p>
