  ...
  <table style="margin: 0; padding: 20px 20px; width: 650px; margin: 0 auto; background-color: #fff;" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="center" class="check">
        ...
        <h1>Te enviamos tu comprobante de detracción</h1>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td align="center" class="information">
        <h2>¡Hola!</h2>
        <p>Te enviamos el comprobante de detracción de la factura {{ $nro_factura }} de la operación N° {{ $code }} que realizaste con el cliente:</p>
        <h2>{{ $client_name}}</h2>
      </td>
    </tr>
    <tr>
