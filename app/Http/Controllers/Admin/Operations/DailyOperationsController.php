            ...
            $data = array(
                ...
                "items" => array(
                    ...
                    array(
                        ...
                        "descripcion"               => "OP " . $operation->code . " - CLIENTE " . ($operation->type == "Compra" ? "COMPRA " : ($operation->type == "Venta" ? "VENDE " : "TRANSFIERE ")) . $operation->currency->sign . $operation->amount . " - CLIENTE " . ($operation->type == "Compra" ? "ENVIA S/" : ($operation->type == "Venta" ? "RECIBE S/" : ("ENVIA ".$operation->currency->sign." "))) . ($operation->class == 'Inmediata' ? $countervalue : $total_amount) . " - TIPO DE CAMBIO: " . round($operation->exchange_rate, 6),
